export const MENUITEMS = [
   {
      title: 'New Arrival', type: 'sub',
       children: [
         ...
         {
            title: 'BODY SPRAYS', type: 'sub', children: [
         ...
         {
            title: 'PERFUMES', type: 'sub', children: [
         ...
         {
            title: 'TESTERS (20 ML)', type: 'sub', children: [
   ...
   {
      title: 'Bodysprays', megaMenu: true, megaMenuType: 'small', type: 'sub', 
      children: [
         {
