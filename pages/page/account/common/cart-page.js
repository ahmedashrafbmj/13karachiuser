              ...
              <Col sm="12">
                <table className="table cart-table table-responsive-xs">
                  ...
                  {cartItems.map((item, index) => {
                    ...
                    console.log(item?.discountedPrice, "itemcat")
                    console.log(item, "itemcat")
                    return (
                      <tbody key={index}>
                        <tr>
                          <td>
                            <Link href={`/product-details/` + item.name}>
                              <a>
                                <Media
                                  src={
                                    item.images
                            ...
                            <div className="qty-box">
                              <div className="input-group">
                                <input
                                  ...
                                  onWheel={(e) => {
                                    // alert(e,"eeeeeeeeeee")
                                    // Prevent mouse wheel scrolling to decrease the input value when qty is 1
                                    if (item.qty === 1 && e.deltaY < 0) {
                                      e.preventDefault();
                                    }
                                  }}
                                />
